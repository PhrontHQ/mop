...
function globToRegExp(pattern) {
    ...
    var inner = pattern.replace(ESCAPE_GLOB_REG, function (_, ss, s, q, other) {
        if (ss) {
            return "([^/\\\\]*(?:/|\\\\))*";
        } else if (s) {
            return "[^/\\\\]*?";
...
// var defaultExclude = ["**/README", "**/CHANGES", "**/LICENSE", "**/*.txt", "**/*.md"];
var defaultExclude = ["**/README", "**/CHANGES", "**/LICENSE", "**/*.txt", "**/*.md", "**/tsconfig.json", "**/tsconfig.module.json", "**/tsdoc-metadata.json"];
